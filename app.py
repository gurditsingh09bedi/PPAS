...
st.sidebar.markdown(
    "<h1 style='text-align: center; color: #333;'>Precision Physician Allocation System</h1>", 
    unsafe_allow_html=True
)
...
# Main conversation logic without GIF background
with container:
                ...
                for i in range(len(st.session_state['messages'])):
                    if (i % 2) == 0:
                        ...
                        with st.container():
                            ...
                            with col2:
                                st.markdown(f"<div class='ai-message'>{st.session_state['messages'][i]}</div>", unsafe_allow_html=True)
